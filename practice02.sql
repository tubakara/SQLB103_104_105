...
select * from child;
select * from parent;
--SORU 1: child tablosuna ted_verginosu 101 olan veri girişi yapin
insert into child values(101,2000,'Araba','Burak');
--SORU 2: .child tablosuna ted_verginosu 105 olan veri girişi yapınız.
--cevap parent tabloda olmayan primary key ile child tabloya veri girisi yapilamaz

insert into child values (105,5678,'Araba','Tugba');
--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child values (null,5670,'Motor','Tugba');delete from child where tedarik_vergino=12;
...
--soru 8 child tablo silin
drop table child
--SORU 9: .parent tablosunu siliniz
drop table parent-- child silindigi icin silebiliriz artik
...
--soru 1 vergi nosu 202 olan toptancinin sirket ismini vivibook yap
